...
public class Deserializador {
    public static <E> void deserializador(List<E> list, String className) {
        ...
        try {
            String path = System.getProperty("user.dir") + "/baseDatos/temp/" + className + ".txt"; // Ruta del archivo que se va a cargar            File archivo = new File(path);  // Ruta donde crear este archivo, si aun no existe            archivo.createNewFile(); // Crear un nuevo archivo, si no existe
