...
//	}
	...
	public static Tiquete generarTiquete(int codigo, Pasajero pasajero, String silla, Viaje viaje, int valor, LocalDate fechaCompra) {
		return new Tiquete(codigo, pasajero, silla, viaje, valor, fechaCompra);
	}
